...
const USER_PROFILE_IMAGE = 'https://api.dicebear.com/7.x/avataaars/svg?seed=user&backgroundColor=b6e3f4'
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                {isEditing ? (
                                    ...
                                    <p className="px-4 py-3 bg-slate-50 rounded-xl text-slate-800 font-medium">{user.name}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="px-4 py-3 bg-slate-100 rounded-xl text-slate-600">{user.email}</p>
                            ...
                            <div className="space-y-2">
                                ...
                                {isEditing ? (
                                    ...
                                    <p className="px-4 py-3 bg-slate-50 rounded-xl text-slate-800 font-medium">{user.phone}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {isEditing ? (
                                    ...
                                    <p className="px-4 py-3 bg-slate-50 rounded-xl text-slate-800 font-medium">{user.pincode}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2 md:col-span-2">
                                ...
                                {isEditing ? (
                                    ...
                                    <p className="px-4 py-3 bg-slate-50 rounded-xl text-slate-800 font-medium">{user.address}</p>
                                )}
                            </div>
                        </div>
                        ...
                        {isEditing && (
                            <div className="flex gap-4 mt-8">
                                <button
                                    onClick={handleSave}
                                    disabled={loading}
                                    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50"
                                >
                                    <FaSave />
